  ...
  return (
    <div className="sidebar__content">
      ...
      <ul className="sidebar__block">
        ...
        <SidebarCategory title="Products" icon="cart" sidebarCollapse={sidebarCollapse}>
          <SidebarLink title="Add Product" route="/e-commerce/product_add" onClick={hideSidebar} />
          {/* <SidebarLink title="Single Product" route="/e-commerce/product_page" onClick={hideSidebar} /> */}
          <SidebarLink title="Products" route="/e-commerce/products_list" onClick={hideSidebar} />
        </SidebarCategory>
      ...
      <ul className="sidebar__block">
        ...
        <SidebarCategory title="Orders" icon="list" sidebarCollapse={sidebarCollapse}>
          <SidebarLink title="View Orders" route="/e-commerce/orders_list" onClick={hideSidebar} />
        </SidebarCategory>
